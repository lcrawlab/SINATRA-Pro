...
if not os.path.exists(directory):
    os.mkdir(directory)
if not os.path.exists("%s_hemisphere"%directory):
    os.mkdir("%s_hemisphere"%directory)
...
np.savetxt("%s/directions_%d_%d_%.1f_hemisphere.txt"%(directory,n_cone,n_direction_per_cone,cap_radius),directions)
...
for offset in range(0,100,10):
    ...
    np.savetxt("%s_hemisphere/DECT_original_perturbed_%d_%d_%.1f_%d_norm_offset_%d.txt"%(directory,n_cone,n_direction_per_cone,cap_radius,n_filtration,offset),X)
    np.savetxt('%s_hemisphere/original_perturbed_label.txt'%directory,y)
    np.savetxt("%s_hemisphere/notvacuum_DECT_original_perturbed_%d_%d_%.1f_%d_norm_offset_%d.txt"%(directory,n_cone,n_direction_per_cone,cap_radius,n_filtration,offset),not_vacuum)
    ...
    np.savetxt("%s_hemisphere/rates_DECT_original_perturbed_%d_%d_%.1f_%d_offset_%d.txt"%(directory,n_cone,n_direction_per_cone,cap_radius,n_filtration,offset),rates)
    ...
    np.savetxt("%s_hemisphere/vert_prob_DECT_original_perturbed_%d_%d_%.1f_%d_offset_%d.txt"%(directory,n_cone,n_direction_per_cone,cap_radius,n_filtration,offset),vert_prob)
    ...
    write_vert_prob_on_pdb(vert_prob,protA=protA,protB=protB,selection=selection,pdb_in_file="%s/pdb/offset_%d/%s_frame0.pdb"%(directory,offset,prot),pdb_out_file="%s_hemisphere/vert_prob_DECT_original_perturbed_%d_%d_%.1f_%d_offset_%d.pdb"%(directory,n_cone,n_direction_per_cone,cap_radius,n_filtration,offset))
