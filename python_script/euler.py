...
def compute_ec_curve_folder(protA, protB, directions, n_sample = 101, ec_type = "ECT", n_cone = 15, n_direction_per_cone = 4, cap_radius = 0.1, n_filtration = 25, ball_radius = 1.0, include_faces = True, directory_mesh_A = None, directory_mesh_B = None, sm_radius = 4.0, hemisphere=False, parallel = False, n_core = -1):
