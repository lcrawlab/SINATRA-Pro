...
int main (int argc, char *argv[])
{
    ...
    string directory = "../WT_R164S_65_230";
    //string pdbpath_A = "../../python_script/WT_R164S_65_230/pdb/WT_offset_0/";
    string pdbpath_A = "/mnt/d/share/sinatra_python/python_package/tests/WT_R164S_65_230_2.0/pdb/WT_offset_0/";
    string mshpath_A = "../WT_R164S_65_230/msh/WT_offset_0/";
    //string pdbpath_B = "../../python_script/WT_R164S_65_230/pdb/R164S_offset_0/";
    string pdbpath_B = "/mnt/d/share/sinatra_python/python_package/tests/WT_R164S_65_230_2.0/pdb/R164S_offset_0/";
    string mshpath_B = "../WT_R164S_65_230/msh/R164S_offset_0/";
    /** 
    ...
    **/
    ...
    cout << directions[0][0] << ' ' << directions[0][1] << ' ' << directions[0][2] << endl;
    ...
    //rates_vert.load(directory+"/rates_vert"+filesuffix+".txt",raw_ascii);
